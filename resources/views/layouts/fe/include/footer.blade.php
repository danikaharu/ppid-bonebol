                ...
                <div class="col-md-8 col-lg-7">
                    ...
                    <form action="{{ route('kontakkami') }}" method="post" class="contact-form">
                        ...
                        <div class="form-group">
                            <textarea name="pesan" cols="30" rows="5" class="form-control @error('pesan') is-invalid @enderror"
            ...
            <div class="row align-items-center justify-content-center">
                <div class="col-md-6 text-center text-md-left">
                    <p class="mb-0">Copyright
                        ...
                        </script> &copy; <a target="_blank" href="https://ppid.bonebolangokab.go.id">PPID
                            Bone
                            Bolango</a>
                    </p>
                </div>
                <div class="col-md-6 text-center text-md-right">
                    <div class="social-links">
                        <a href="{{ $profilkantor->fb ?? '' }}" class="link" target="_blank"><i
                                class="ti-facebook"></i></a>
                        <a href="{{ $profilkantor->tw ?? '' }}" class="link" target="_blank"><i
                                class="ti-twitter-alt"></i></a>
                        <a href="{{ $profilkantor->ig ?? '' }}" class="link" target="_blank"><i
