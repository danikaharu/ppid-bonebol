@if (request()->routeIs('infopub', 'pemohon.register', 'pemohon.index', 'statistik'))
...
@endif
<div class="container">
    <a class="navbar-brand" href="#"><img src="{{ asset('be/assets/images/ppidbonebol.png') }}" alt=""
            class="brand-img" style="width: 80px;"></a>
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
        <ul class="navbar-nav ml-auto">
            ...
            <li class="nav-item">
                <a class="nav-link" href="{{ route('pemohon.index') }}">Permohonan Informasi</a>
            </li>
            <li class="nav-item">
            ...
            <li class="nav-item ml-0 ml-lg-4">
                @auth
                    <a class="nav-link btn btn-primary" href="{{ route('login') }}"><i class="ti-login"></i>Hi,
                        {{ Auth::user()->name }}</a>
                @else
