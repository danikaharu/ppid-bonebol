...
@section('container')
    <div class="page-title">
        <div class="d-flex justify-content-between align-items-center">
            <div class="d-flex mb-4 gap-3 align-items-center">
                <a href="{{ route('admin.pengajuankeberatan.index') }}" class="btn btn-dark icon">
    ...
    <section id="basic-vertical-layouts">
        <div class="row match-height">
            <div
                class="@role('admin') @if ($data->status != 0) col-lg-6 @else col-lg-4 @endif @endrole @role('petugas') @if ($data->status != 0) col-lg-6 @else col-lg-4 @endif @endrole @role('user') col-lg-4 @endrole col-12">
                <div class="card mb-4">
                                ...
                                <div class="row">
                                    <div class="col-12">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <p>{{ \Carbon\Carbon::createFromFormat('Y-m-d H:i:s', $data->created_at)->isoFormat('dddd, D MMMM Y') }}
                                            </p>
                                        </div>
                                        <div class="form-group">
                                            <h6 class="fw-bold">Waktu Pengajuan</h6>
                                            <p>{{ \Carbon\Carbon::createFromFormat('Y-m-d H:i:s', $data->created_at)->isoFormat('HH:mm') }}
                                                WITA</p>
                                        </div>
                                        <div class="form-group">
                            ...
                            <div class="card">
                                <div class="card-body">
                                    <div class="d-flex gap-2 justify-content-between">
                                        <form action="{{ route('admin.pengajuankeberatan.tolak', $data->id) }}"
                                            method="post" onsubmit="return confirm('Yakin tolak pengajuan ini?')">
                                            @csrf
                                            @method('put')
                                        ...
                                        <form action="{{ route('admin.pengajuankeberatan.terima', $data->id) }}"
                                            method="post" onsubmit="return confirm('Yakin terima pengajuan ini?')">
                                            @csrf
                                            @method('put')
            ...
            @if ($data->status == 1)
                @if (!empty($data->permohonaninformasi->pesan) && !empty($data->permohonaninformasi->file))
                    <div
                        class="@role('admin') col-lg-6 @endrole @role('petugas') col-lg-6 @endrole @role('user') col-lg-4 @endrole col-12">
                        <div class="card">
                            <div class="card-body">
                                <div class="d-flex justify-content-between align-items-center">
                                    <h4>Pesan & File</h4>
                                ...
                                <div class="form-group">
                                    ...
                                    <p><a href="{{ asset($data->permohonaninformasi->file) }}" target="_blank"><i
                                                data-feather="file-text"></i>{{ $data->permohonaninformasi->file }}</a></p>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-6 col-12">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <hr>
                                <form id="mySend"
                                    action="{{ route('admin.pengajuankeberatan.sendterima', $data->permohonaninformasi->id) }}"
                                    method="post" enctype="multipart/form-data"
                                    onsubmit="return confirm('Data yang anda masukkan sudah benar?')">
                                    @csrf
                                    @method('put')
                                    <div class="form-group">
                                        <label class="fw-bold">pesan</label>
                    ...
                    <div class="col-lg-6 col-12">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <hr>
                                <form id="mySend2" action="{{ route('admin.pengajuankeberatan.sendtolak', $data->id) }}"
                                    method="post" onsubmit="confirm('Data yang anda masukkan sudah benar?')">
                                    @csrf
                                    @method('put')
                                    <div class="form-group">
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="form-group">
                            ...
                            <p>{{ \Carbon\Carbon::createFromFormat('Y-m-d H:i:s', $data->permohonaninformasi->created_at)->isoFormat('dddd, D MMMM Y') }}
                            </p>
                        </div>
                        <div class="form-group">
                            <label class="fw-bold">Waktu Permohonan</label>
                            <p>{{ \Carbon\Carbon::createFromFormat('Y-m-d H:i:s', $data->permohonaninformasi->created_at)->isoFormat('H:m') }}
                                WITA</p>
                        </div>
                        <div class="form-group">
            ...
            @role('admin')
                <div
                    class="@role('admin') @if ($data->status != 0) col-lg-6 @else col-lg-4 @endif @endrole @role('user') col-lg-6 @endrole col-12">
                    <div class="card">
                        <div class="card-body">
            ...
            @role('petugas')
                <div
                    class="@role('petugas') @if ($data->status != 0) col-lg-6 @else col-lg-4 @endif @endrole @role('user') col-lg-6 @endrole col-12">
                    <div class="card">
                        <div class="card-body">
                            <h4>Biodata Pemohon</h4>
                            <hr>
