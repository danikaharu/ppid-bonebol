                    ...
                    <div class="card">
                        <div class="card-content">
                            <div class="card-body">
                                                ...
                                                <div class="col-12">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text"
                                                            ...
                                                            name="name" id="basicInput" value="{{ $user->name }}">
                                                        @error('name')
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <input type="email"
                                                            ...
                                                            name="email" id="basicInput" value="{{ $user->email }}">
                                                        @error('email')
                                                            <div class="alert alert-danger">
                                                                {{ $message }}
                                                            </div>
                                ...
                                @else
                                    <form action="{{ route('admin.pemohon.update', $user->id) }}" method="POST"
                                                ...
                                                <div class="col-12">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text"
                                                            ...
                                                            name="no_identitas" id="basicInput"
                                                            value="{{ $user->biodata->no_identitas }}">
                                                        @error('no_identitas')
                                                            <div class="alert alert-danger">
                                                                {{ $message }}
                                                            </div>
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="form-file">
                                                            <input type="hidden" name="file_lama"
                                                                value="{{ $user->biodata->file_path }}">
                                                            <input type="file" class="form-control-file" name="file"
                                                                id="basicInput">
                                                        </div>
                                                        <small>*File yang boleh diupload jpg, jpeg, png dan maksimal
                                                            2MB.</small>
                                                        @error('file')
                                                            <div class="alert alert-danger">
                                                                {{ $message }}
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text"
                                                            ...
                                                            name="pekerjaan" id="basicInput"
                                                            value="{{ $user->biodata->pekerjaan }}">
                                                        @error('pekerjaan')
                                                            <div class="alert alert-danger">
                                                                {{ $message }}
                                                            </div>
