                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class="d-flex justify-content-between align-items-center">
                                ...
                                @if (request()->routeIs('admin.petugas.show'))
                                    <a href="{{ route('admin.petugas.edit', $user->id) }}" class="btn icon btn-warning"><i
                                            data-feather="edit"></i> Edit</a>
                                @else
                                    <a href="{{ route('admin.pemohon.edit', $user->id) }}" class="btn icon btn-warning"><i
                                            data-feather="edit"></i> Edit</a>
                                @endif
                            </div>
                            <hr>
                            ...
                            @if (request()->routeIs('admin.pemohon.show'))
                                <div class="form-group">
                                    ...
                                    <br>
                                    <a href="{{ asset($user->biodata->file_path) }}" target="_blank"
