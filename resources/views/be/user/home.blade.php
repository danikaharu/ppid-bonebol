                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        btn-warning icon">
                                                ...
                                                <a href={{ route('admin.petugas.password', $user->id) }}
                                                    class="btn
                                        btn-info icon"
                                        ...
                                        @elseif(request()->routeIs('admin.pemohon'))
                                            <form action={{ route('admin.pemohon.destroy', $user->id) }} method="post"
                                                ...
                                                @csrf
                                                @method('delete')
                                                <a href={{ route('admin.pemohon.show', $user->id) }}
                                                    class="btn btn-dark
                                        icon">
                                                    <i data-feather="eye" width="20"></i>
                                                </a>
                                                <a href={{ route('admin.pemohon.edit', $user->id) }}
                                                    class="btn
                                        btn-warning icon">
                                                    <i data-feather="edit" width="20"></i>
                                                </a>
                                                <a href={{ route('admin.pemohon.password', $user->id) }}
                                                    class="btn
                                        btn-info icon"
                                                    title="Ganti Password">
                                                    <i data-feather="key" width="20"></i>
