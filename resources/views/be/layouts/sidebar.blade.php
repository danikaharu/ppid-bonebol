        ...
        <div class="sidebar-menu">
            <ul class="menu">
                ...
                @role('petugas')
                    ...
                    <li class="sidebar-item @if (request()->routeIs(
                            'petugas.informasipublik',
                            'petugas.informasipublik.create',
                            'petugas.informasipublik.show',
                            'petugas.informasipublik.edit')) active @endif">
