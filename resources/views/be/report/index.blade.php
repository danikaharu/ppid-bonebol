    ...
    <div class="main-content container-fluid">
        ...
        <section class="section">
            <div class="row">
                <div class="col-12">
                    <div class="card">
                        <div class="card-body">
                            <h5>Cari Laporan</h5>
                            <hr>
                            <form action="{{ route('admin.report.search') }}" method="get" role="search">
                                @csrf
                                <div class="row">
                                    ...
                                    <div id="forStatusPermoinfo" class="col-12 col-lg-4">
                                        <div class="form-group">
                                            <select name="status_permoinfo" class="form-control">
                                                ...
                                                <option value="0"
                                                    {{ request('status_permoinfo') == '0' ? 'selected' : '' }}>Belum
                                                    Diproses</option>
                                                <option value="1"
                                                    {{ request('status_permoinfo') == '1' ? 'selected' : '' }}>Diproses
                                                </option>
                                                <option value="2"
                                                    {{ request('status_permoinfo') == '2' ? 'selected' : '' }}>Diterima
                                                </option>
                                                <option value="3"
                                                    {{ request('status_permoinfo') == '3' ? 'selected' : '' }}>Ditolak
                                                </option>
                                                <option value="4"
                                                    {{ request('status_permoinfo') == '4' ? 'selected' : '' }}>Keberatan
                                                    Diproses</option>
                                            </select>
                                        </div>
                                    </div>
                                    <div id="forStatusPengkeb" class="col-12 col-lg-4">
                                        <div class="form-group">
                                            <select name="status_pengkeb" class="form-control">
                                                <option value="">-Pilih Status-</option>
                                                <option value="0"
                                                    {{ request('status_pengkeb') == '0' ? 'selected' : '' }}>
                                                    Belum Diproses</option>
                                                <option value="1"
                                                    {{ request('status_pengkeb') == '1' ? 'selected' : '' }}>
                                                    Diterima</option>
                                                <option value="2"
                                                    {{ request('status_pengkeb') == '2' ? 'selected' : '' }}>
                                                    Ditolak</option>
                                            </select>
                                        </div>
                                    </div>
                                        ...
                                        <div class="col-12 col-lg-4">
                                            <div class="form-group">
                                                <a href="{{ route('admin.laporan') }}"
                                                    class="btn btn-block btn-secondary"><i data-feather="refresh-cw"></i>
                                                    Refresh</a>
                                            </div>
                                        </div>
                                    @endif
                ...
                @if (request()->routeIs('admin.report.search'))
                                        ...
                                        <tbody>
                                            @foreach ($datas as $item)
                                                <tr>
                                                    ...
                                                    <td>{{ $item->user->name }}</td>
                                                    <td>{{ \Carbon\Carbon::createFromFormat('Y-m-d H:i:s', $item->created_at)->isoFormat('LLLL') }}
                                                    </td>
                                                </tr>
                                            @endforeach
                                        </tbody>
