                    ...
                    <div class="card-content">
                        <div class="card-body">
                            @role('admin')
                                ...
                                @endrole
                                @role('petugas')
                                    <form action="{{ route('petugas.informasipublik.update', $data->id) }}" method="POST"
                                        enctype="multipart/form-data">
                                    @endrole
                                    @csrf
                                    @method('put')
                                        ...
                                        <div class="row">
                                            <div class="col-12">
                                                ...
                                                <fieldset class="form-group">
                                                    <select class="form-select" name="klasifikasi_id" id="basicSelect"
                                                        required>
                                            ...
                                            <div class="col-12">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text"
                                                        ...
                                                        name="judul" id="basicInput" value="{{ $data->judul }}"">
                                                    @error('judul')
