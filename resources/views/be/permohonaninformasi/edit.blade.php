                                    ...
                                    <div class="row">
                                        <div class="col-12">
                                            <div class="form-group">
                                                ...
                                                <textarea name="rincian" rows="5" class="form-control @error('rincian') is-invalid @enderror">{{ $data->rincian }}</textarea>
                                            </div>
                                            <div class="form-group">
                                                <h6 class="fw-bold">Tujuan Penggunaan Informasi</h6>
                                                <textarea name="tujuan" rows="5" class="form-control @error('tujuan') is-invalid @enderror">{{ $data->tujuan }}</textarea>
                                            </div>
                                            <div class="form-group">
                                                <h6 class="fw-bold">Mendapatkan Salinan Informasi</h6>
                                                <div class="d-flex gap-3">
                                                    <div class="form-check">
                                                        <input class="form-check-input" type="radio" value="Soft Copy"
                                                            name="mendapat" id="mendapat1"
                                                            {{ $data->mendapat == 'Soft Copy' ? 'checked' : '' }}>
                                                        <label class="form-check-label" for="mendapat1">
                                                            Soft Copy
                                                        </label>
                                                    </div>
                                                    <div class="form-check">
                                                        <input class="form-check-input" type="radio" value="Hard Copy"
                                                            name="mendapat" id="mendapat2"
                                                            {{ $data->mendapat == 'Hard Copy' ? 'checked' : '' }}>
                                                ...
                                                <div class="d-flex gap-3">
                                                    <div class="form-check">
                                                        <input class="form-check-input" type="radio"
                                                            value="Mengambil Langsung" name="cara" id="cara1"
                                                            {{ $data->cara == 'Mengambil Langsung' ? 'checked' : '' }}>
                                                    ...
                                                    <div class="form-check">
                                                        <input class="form-check-input" type="radio"
                                                            value="Online By System" name="cara" id="cara2"
                                                            {{ $data->cara == 'Online By System' ? 'checked' : '' }}>
