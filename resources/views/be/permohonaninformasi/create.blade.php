                                    ...
                                    <div class="row">
                                        <div class="col-12">
                                            <div class="form-group">
                                                ...
                                                <textarea name="rincian" rows="5" class="form-control @error('rincian') is-invalid @enderror">{{ old('rincian') }}</textarea>
                                                @error('rincian')
                                            ...
                                            <div class="form-group">
                                                ...
                                                <textarea name="tujuan" rows="5" class="form-control @error('tujuan') is-invalid @enderror">{{ old('tujuan') }}</textarea>
                                                @error('tujuan')
                                                    <div class="invalid-feedback">
                                                        {{ $message }}
                                                    </div>
