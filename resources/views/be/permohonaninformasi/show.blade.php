...
@section('container')
    <div class="page-title">
        <div class="d-flex justify-content-between align-items-center">
            <div class="d-flex mb-4 gap-3 align-items-center">
                <a href={{ route('admin.permohonaninformasi.index') }} class="btn btn-dark icon">
    ...
    <section id="basic-vertical-layouts">
        <div class="row match-height">
            <div
                class="@if ($data->status == 2) col-lg-4 @elseif($data->status == 3) col-lg-4 @else col-lg-6 @endif col-12">
                <div class="card">
                    <div class="card-body">
                        <div class="d-flex justify-content-between align-items-center">
                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <p><a href="{{ asset($data->file) }}" target="_blank"><i
                                                data-feather="file-text"></i>{{ $data->file }}</a></p>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="col-lg-4 col-12">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <hr>
                                    <form id="mySend"
                                        action="{{ route('admin.permohonaninformasi.sendterima', $data->id) }}" method="post"
                                    ...
                                    <div class="form-group">
                                        <div class="d-flex gap-2">
                                            <form action="{{ route('admin.permohonaninformasi.batalterima', $data->id) }}"
                                                method="post"
                                                onsubmit="return confirm('Yakin membatalkan permohonan informasi ini?')">
                                                @csrf
                                                @method('put')
                                            ...
                                            <a href="javascript:{}" class="btn btn-primary fw-bold"
                                                onclick="if(!confirm('Data yang anda masukkan sudah benar?')){return false;}else{document.getElementById('mySend').submit();}">
                        ...
                        <div class="col-lg-4 col-12">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <hr>
                                    <form id="mySend2"
                                        action="{{ route('admin.permohonaninformasi.sendtolak', $data->id) }}"
                                        method="post">
                                        @csrf
                                        @method('put')
                                        <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        <div class="d-flex gap-2">
                                            ...
                                            <a href="javascript:{}" class="btn btn-primary fw-bold"
                                                onclick="if(!confirm('Data yang anda masukkan sudah benar?')){return false;}else{document.getElementById('mySend2').submit();}">
        ...
        @if ($data->status == 1)
            <div class="row">
                <div class="col-12">
                    <div class="d-flex gap-2">
                        <form action="{{ route('admin.permohonaninformasi.tolak', $data->id) }}" method="post"
                            onsubmit="return confirm('Yakin menolak permohonan informasi ini?')">
                            @csrf
                            @method('put')
                        ...
                        <form action="{{ route('admin.permohonaninformasi.terima', $data->id) }}" method="post"
                            onsubmit="return confirm('Yakin menerima permohonan informasi ini?')">
                            @csrf
                            @method('put')
