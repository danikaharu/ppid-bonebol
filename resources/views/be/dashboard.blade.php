                        ...
                        <div class="card shadow-sm">
                            <div class="card-body">
                                @role('admin')
                                    <div class="d-flex justify-content-between align-items-center">
                                        ...
                                        <span class="badge bg-warning badge-pill badge-round ml-1">
                                            <h6 class="m-0 text-white">{{ $permoinfo_belum ?? '' }}</h6>
                                        </span>
                                    </div>
                                    <hr>
                                @endrole
                                <div class="d-flex justify-content-between align-items-center">
                                    ...
                                    <span class="badge bg-info badge-pill badge-round ml-1">
                                        <h6 class="m-0 text-white">{{ $permoinfo_diproses ?? '' }}</h6>
                                    </span>
                                </div>
                                <hr>
                                <div class="d-flex justify-content-between align-items-center">
                                    <h5 class="m-0">Diterima</h5>
                                    <span class="badge bg-success badge-pill badge-round ml-1">
                                        <h6 class="m-0 text-white">{{ $permoinfo_diterima ?? '' }}</h6>
                                    </span>
                                </div>
                                <hr>
                                <div class="d-flex justify-content-between align-items-center">
                                    ...
                                    <span class="badge bg-danger badge-pill badge-round ml-1">
                                        <h6 class="m-0 text-white">{{ $permoinfo_ditolak ?? '' }}</h6>
                                    </span>
                                </div>
                                <hr>
                                <div class="d-flex justify-content-between align-items-center">
                                    ...
                                    <span class="badge bg-info badge-pill badge-round ml-1">
                                        <h6 class="m-0 text-white">{{ $permoinfo_keberatan ?? '' }}</h6>
                                    </span>
                                </div>
                                <div class="d-flex justify-content-center mt-3">
                                    <a href="{{ route('admin.permohonaninformasi.index') }}" class="small">Lihat Detail</a>
                                </div>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="card-body">
                                @role('admin')
                                    <div class="d-flex justify-content-between align-items-center">
                                        <h5 class="m-0">Belum diproses</h5>
                                        <span class="badge bg-warning badge-pill badge-round ml-1">
                                            <h6 class="m-0 text-white">{{ $pengkeb_belum ?? '' }}</h6>
                                        </span>
                                    </div>
                                    <hr>
                                @endrole
                                <div class="d-flex justify-content-between align-items-center">
                                    <h5 class="m-0">Diterima</h5>
                                    <span class="badge bg-success badge-pill badge-round ml-1">
                                        <h6 class="m-0 text-white">{{ $pengkeb_diterima ?? '' }}</h6>
                                    </span>
                                </div>
                                <hr>
                                <div class="d-flex justify-content-between align-items-center">
                                    <h5 class="m-0">Ditolak</h5>
                                    <span class="badge bg-danger badge-pill badge-round ml-1">
                                        <h6 class="m-0 text-white">{{ $pengkeb_ditolak ?? '' }}</h6>
                                    </span>
                                </div>
                                <div class="d-flex justify-content-center mt-3">
                                    <a href="{{ route('admin.pengajuankeberatan.index') }}" class="small">Lihat Detail</a>
                                </div>
                            </div>
                        </div>
                    </div>
        ...
        <div class="row">
            <div class="col-12 col-lg-8">
                <div class="card">
                    <div class="card-body">
                        <div
                            class="d-flex align-items-center flex-column flex-lg-row justify-content-center justify-content-lg-between">
                        ...
                        <p style="text-align: justify;">
                            Pejabat Pengelola Informasi dan Dokumentasi (PPID) Bonel Bolango adalah pejabat yang bertanggung
                            jawab di bidang penyimpanan,
                            pendokumentasian, penyediaan, dan/atau pelayanan informasi di Pemerintah Bone Bolango. Dengan
                            keberadaan PPID maka masyarakat yang akan
                            menyampaikan permohonan informasi lebih mudah dan tidak berbelit karena dilayani lewat satu
                            pintu.
                        </p>
                    </div>
                </div>
