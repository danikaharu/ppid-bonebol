                ...
                <div class="card">
                    <div class="card-body">
                        <div class="d-flex align-items-center justify-content-between">
                            ...
                            <a href="{{ route('admin.account.password') }}" class="btn icon btn-primary fw-bold"><i
                                    data-feather="key"></i> Ganti Password</a>
                        </div>
                        <hr>
                        @role('admin')
                            ...
                            <form action="{{ route('user.akun.update', Auth::user()->id) }}" method="post"
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="no_identitas"
                                        ...
                                        value="{{ Auth::user()->biodata->no_identitas }}">
                                    @error('no_identitas')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="no_telp"
                                        ...
                                        value="{{ Auth::user()->biodata->no_telp }}">
                                    @error('no_telp')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                                <div class="form-group">
                                    ...
                                    <input type="text" name="pekerjaan"
                                        ...
                                        value="{{ Auth::user()->biodata->pekerjaan }}">
                                    @error('pekerjaan')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
