...
@section('content')
    ...
    <section class="section mt-5">
        <div class="container">
            ...
            <form action="{{ route('pemohon.store', ['jenis' => 'lembaga']) }}" method="post" enctype="multipart/form-data">
                @csrf
                <div class="row">
                    <div class="col-lg-6">
                        <div id="hidden_div_lembaga" class="form-group">
                            ...
                            <input type="text" name="no_identitas"
                                ...
                                placeholder="" value="{{ old('no_identitas') }}">
                            @error('no_identitas')
                        ...
                        <div id="hidden_div_lembaga_1" class="form-group">
                            ...
                            <input type="text" name="name" class="form-control @error('name') is-invalid @enderror"
                                id="nama1" placeholder="" value="{{ old('name') }}">
                            @error('name')
                                <div class="invalid-feedback">
                                    {{ $message }}
                                </div>
