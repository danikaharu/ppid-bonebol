                ...
                <div class="carousel-inner">
                    <div class="carousel-item active">
                        <div class="carousel-caption d-none d-md-block">
                            ...
                            <a href="{{ route('infopub') }}" class="btn btn-primary btn-rounded"><i class="ti-info-alt"></i>
                                Informasi Publik</a>
                        </div>
                    </div>
                    ...
                    <div class="row justify-content-between">
                        ...
                        <div class="col">
                            ...
                            <div class="social-links">
                                <a href="{{ $profilkantor->fb ?? '' }}" class="link pr-1" target="_blank"><i
                                        class="ti-facebook"></i></a>
                                <a href="{{ $profilkantor->tw ?? '' }}" class="link pr-1" target="_blank"><i
                                        class="ti-twitter-alt"></i></a>
                                <a href="{{ $profilkantor->ig ?? '' }}" class="link pr-1" target="_blank"><i
