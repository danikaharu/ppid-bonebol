                    ...
                    <table id="myDataTable" class="table table-striped" style="width:100%">
                        ...
                        <tbody>
                            @foreach ($datas as $item)
                                <tr>
                                    <td>{{ \Carbon\Carbon::createFromFormat('Y-m-d H:i:s', $item->created_at)->isoFormat('D MMMM Y HH:mm') }}
                                    </td>
                                    ...
                                    <td><a href="{{ route('download.infopub', $item->id) }}" target="_blank"
                                            class="btn btn-sm btn-primary circle"> <i class="ti-download"></i> </a></td>
                                </tr>
                            @endforeach
                        </tbody>
                    </table>
